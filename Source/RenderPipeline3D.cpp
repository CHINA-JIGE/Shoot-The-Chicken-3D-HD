...
bool IRenderPipeline3D::Init(RenderPipeline_InitData & initData)
{
	...
	{
		m_pRefOutColorBuffer = initData.pOutColorBuffer;
	}
	else
	{
...
void IRenderPipeline3D::PixelShader_DrawTriangles(RasterizedFragment& inVertex)
{
	...
	//render target has been bound in the init stage
	m_pRefOutColorBuffer->at(inVertex.pixelY*mBufferWidth + inVertex.pixelX) = outColor;
}
